...
require('../crud/eqs_disponiveis.php');

##Guardar id do equipamento para aceder a pagina em detalhes
if(isset($_POST['eqdetail'])){
    $row=array('eqid'=>$_POST['eqid']);
    $_SESSION['id_eq'] = $_POST['eqid'];
    header("Location: EQDtails.php");
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <header class="bg-dark py-4">
            <div class="container px-1 px-lg-5">
                <div class="text-left text-white">
                    <h1 class="display-4 fw-bolder">Equipamentos Disponíveis</h1>
                </div>
            </div>
            <div class="container px-4 px-lg-5 mt-5">
                <form action="" method="post">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Pesquisar equipamento por nome..." name="pesquisa">
    ...
    <!-- Equipamentos Disponiveis Lista -->
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <!--Call da função que mostra todos os equipamentos disponiveis-->
                    <?php
                    if(isset($_POST['pesquisa'])){
                        $pesquisa = $_POST['pesquisa'];
                        show_pesquisa($pesquisa);
                    } else {
                        show_eqs();
                    }
                    ?>
