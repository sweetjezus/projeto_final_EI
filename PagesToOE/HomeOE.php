...
require('../crud/meus_equipamentos.php');
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="HomeOE.php">Meus Equipamentos</a></li>
        ...
        <header class="bg-dark py-4">
            <div class="container px-1 px-lg-5">
                <div class="text-left text-white">
                    <h1 class="display-4 fw-bolder">Meus Equipamentos</h1>
                </div>
            </div>
        </header>
